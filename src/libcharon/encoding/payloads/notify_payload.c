...
ENUM_NEXT(notify_type_names, UNITY_LOAD_BALANCE, UNITY_LOAD_BALANCE, DPD_R_U_THERE_ACK,
	"UNITY_LOAD_BALANCE");
ENUM_NEXT(notify_type_names, INTERMEDIATE_EXCHANGE_SUPPORTED, USE_BEET_MODE, UNITY_LOAD_BALANCE,
...
ENUM_NEXT(notify_type_short_names, UNITY_LOAD_BALANCE, UNITY_LOAD_BALANCE, DPD_R_U_THERE_ACK,
	"UNITY_LB");
ENUM_NEXT(notify_type_short_names, INTERMEDIATE_EXCHANGE_SUPPORTED, USE_BEET_MODE, UNITY_LOAD_BALANCE,
	"IKE_INT_SUP",
	"ADD_KE",
	"BEET_MODE");
