...
ENUM_NEXT(notify_type_names, ME_MEDIATION, RADIUS_ATTRIBUTE, USE_BEET_MODE,
	...
	"ME_RESPONSE",
	"RADIUS_ATTRIBUTE");
ENUM_NEXT(notify_type_names, INTERMEDIATE_EXCHANGE_SUPPORTED,
							 INTERMEDIATE_EXCHANGE_SUPPORTED, RADIUS_ATTRIBUTE,
	"INTERMEDIATE_EXCHANGE_SUPPORTED");
ENUM_NEXT(notify_type_names, ADDITIONAL_KEY_EXCHANGE,
							 ADDITIONAL_KEY_EXCHANGE, INTERMEDIATE_EXCHANGE_SUPPORTED,
...
ENUM_NEXT(notify_type_short_names, ME_MEDIATION, RADIUS_ATTRIBUTE, USE_BEET_MODE,
	...
	"ME_R",
	"RADIUS");
ENUM_NEXT(notify_type_short_names, INTERMEDIATE_EXCHANGE_SUPPORTED,
								   INTERMEDIATE_EXCHANGE_SUPPORTED, RADIUS_ATTRIBUTE,
	"IKE_INT_SUP");
